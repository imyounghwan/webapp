...
**⚠️ 주의: 피드백 없는 인터페이스는 사용자 경험을 크게 저하시킵니다.**`
    ...
    N3_1_undo_redo: {
      ...
      recommendation: forms.formCount > 0
        ? '폼이 있어 사용자가 입력을 수정할 수 있는 제어 기능을 제공합니다. 현재 상태를 유지하세요.'
        : '인터랙티브 요소가 제한적입니다 개선이 필요합니다.'
    },
    ...
    N6_3_memory_load: {
      description: navigation.breadcrumbExists
        ...
        : `Breadcrumb이 없어 사용자가 현재 위치를 기억해야 합니다.`,
      recommendation: navigation.breadcrumbExists
        ? '현재 상태를 유지하세요.'
        : 'Breadcrumb이 없어 사용자가 현재 위치를 기억해야 합니다 개선이 필요합니다.'
    },
