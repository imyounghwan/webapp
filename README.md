...
**KRDS 43개 항목 자동 평가 시스템 + Nielsen 10원칙 26개 항목 자동 분석**

## 🎉 현실 세계 일치 분석 추가! (2026-02-06)

### ✨ NEW: Nielsen 2번 원칙 "현실 세계 일치" 개선
...
2. **데이터 자연스러움 (30% 가중치)**
   - ISO 날짜 vs 한국식 날짜 ("2024-02-06" vs "2024년 2월 6일")
   - 시스템 코드 vs 사용자 친화적 표현
   - 콤마 없는 숫자 vs 가독성 좋은 숫자 ("1000000" vs "1,000,000")

3. **인터페이스 친화도 (30% 가중치)**
   - 행동 중심 동사 개수 (클릭, 저장, 검색 등)
   - 사용자 중심 언어 (도와드리겠습니다, 편리하게 등)
   - 현실 세계 은유 (장바구니, 폴더, 휴지통 등)

**분석 결과 예시**:
```
N2.1 친숙한 용어: 전문용어 밀도 3.2%, 평균 문장 길이 15단어 → ✅ 이해하기 쉬움
N2.2 자연스러운 흐름: 자연스러운 표현 비율 78% → 😊 대체로 자연스러움
N2.3 현실 은유: 행동 동사 12개, 현실 은유 5개 → ✅ 직관적
```
